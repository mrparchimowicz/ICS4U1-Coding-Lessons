 ...
 * 
 * Exercise 3.8 - STRING CONCATENATION
 * 
...
public class H_StringConcatenation {
  	public static void main(String[] args){
  		String username = "Mr. Parchimowicz";
  		System.out.println("Your teacher's name is: " + username); // An example to show you how the syntax looks
  		int animals = 12;
